			...
			<g fill="none" fillRule="evenodd" transform="translate(9 8)">
				...
				<g mask="url(#tanstack__c)">
					<g transform="translate(389 -32)">
						...
						<path stroke="url(#tanstack__n)" strokeLinecap="round" strokeLinejoin="bevel" strokeWidth="12" d="M33.5 79.5 7 74" />
						<path stroke="url(#tanstack__n)" strokeLinecap="round" strokeLinejoin="bevel" strokeWidth="12" d="m34 146-29 8" />
						<path stroke="url(#tanstack__n)" strokeLinecap="round" strokeLinejoin="bevel" strokeWidth="12" d="m45 177-24 13" />
						<path stroke="url(#tanstack__n)" strokeLinecap="round" strokeLinejoin="bevel" strokeWidth="12" d="m67 204-20 19" />
						<path stroke="url(#tanstack__n)" strokeLinecap="round" strokeLinejoin="bevel" strokeWidth="12" d="m94.373 227-13.834 22.847" />
						<path stroke="url(#tanstack__n)" strokeLinecap="round" strokeLinejoin="bevel" strokeWidth="12" d="M127.5 243.5 120 268" />
						<path stroke="url(#tanstack__n)" strokeLinecap="round" strokeLinejoin="bevel" strokeWidth="12" d="m167.5 252.5.5 24.5" />
					</g>
				</g>
				<circle cx="307.5" cy="308.5" r="304" stroke="#000" strokeOpacity="0.3" strokeWidth="20" />
			</g>
		</svg>
	);
}
