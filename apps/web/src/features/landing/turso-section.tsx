...
const features = [
	{
		title: "エッジSQLite",
		description:
			"SQLiteの信頼性をエッジで。ユーザーに最も近い場所でクエリを実行",
	},
	{
		title: "グローバルレプリケーション",
		description:
			"データを世界中に自動複製。どこからアクセスしても低レイテンシを実現",
	},
	{
		title: "埋め込みレプリカ",
		description: "アプリ内にデータベースを組み込み。ネットワーク遅延をゼロに",
	},
];

export function TursoSection() {
	return (
		<SplitSection
			brandSide="left"
			accentColor="oklch(0.78 0.18 175)"
			glowClass="glow-turso"
			logo={<TursoLogo />}
			title="Turso"
			subtitle="Edge Database"
			features={features}
		/>
	);
}
